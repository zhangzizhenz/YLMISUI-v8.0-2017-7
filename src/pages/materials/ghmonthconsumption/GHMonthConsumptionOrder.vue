<template>
 <yl-panelpage :titleName="'工号月应耗量'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetGHMonthConsumptionOrderPageList,
            requestDeleteGHMonthConsumptionOrder,
            requestGetGHMonthConsumptionOrderItemPageList,
            requestAuditGHMonthConsumptionOrder,
            requestUnAuditGHMonthConsumptionOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.GHMonthConsumptionOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.GHMonthConsumptionOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.GHMonthConsumptionOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.GHMonthConsumptionOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.GHMonthConsumptionOrders.UnAudit"
                            },
                       },
    ...
    methods:{
        //
         _viewItem(id){
            setTimeout(()=>{
                     this._getGHMonthConsumptionOrderItemPageList(id);
            },300)
        },
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/GHMonthConsumptionOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getGHMonthConsumptionOrderPageList(){
                this.selectRows=[];
                ...
                requestGetGHMonthConsumptionOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
         ...
         _getGHMonthConsumptionOrderItemPageList(id){
                ...
                requestGetGHMonthConsumptionOrderItemPageList(this.itemInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getGHMonthConsumptionOrderPageList();
            this._funcState();
        },
        _itemReload(id){
             this._getGHMonthConsumptionOrderItemPageList(id);
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteGHMonthConsumptionOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
             //初始化表单
            requestAuditGHMonthConsumptionOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditGHMonthConsumptionOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

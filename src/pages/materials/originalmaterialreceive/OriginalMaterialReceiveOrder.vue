<template>
 <yl-panelpage :titleName="'原材料收料单'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetOriginalMaterialReceiveOrderPageList,
            requestDeleteOriginalMaterialReceiveOrder,
            requestGetOriginalMaterialReceiveOrderItemPageList,
            requestAuditOriginalMaterialReceiveOrder,
            requestUnAuditOriginalMaterialReceiveOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            delete:{ 
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.OriginalMaterialReceiveOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.OriginalMaterialReceiveOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.OriginalMaterialReceiveOrders.UnAudit"
                            },
                       },
                        ...
                        columns: [
                         ...
                         //需要时开启预览和明细
                          ...
                          {attr: { prop: 'orderId', label: '预览', width:65, align: 'center',scopedSlot: 'view',showOverflowTooltip:false } },   
                                ...
                                {attr: { prop: 'orderCode', label: '单据编码', width:140,  } },   
                                {attr: { prop: 'allotOrgName', label: '收料单位', width:160,  } },   
                    ...
                    return {
                        ...
                        columns: [
                             {attr: { type: 'index',label: '序号', width:65,align: 'center' }},   
                                ...
                                {attr: { prop: 'boookSum', label: '账面金额', width:100,  } },   
    ...
    methods:{
        ...
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/OriginalMaterialReceiveOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getOriginalMaterialReceiveOrderPageList(){
                this.selectRows=[];
                ...
                requestGetOriginalMaterialReceiveOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getOriginalMaterialReceiveOrderPageList();
            this._funcState();
        },
        _delete(){
            ...
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteOriginalMaterialReceiveOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
            requestAuditOriginalMaterialReceiveOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditOriginalMaterialReceiveOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

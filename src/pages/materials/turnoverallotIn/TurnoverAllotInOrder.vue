...
import {
            requestGetTurnoverAllotInOrderPageList,
            requestDeleteTurnoverAllotInOrder,
            requestGetTurnoverAllotInOrderItemPageList,
            requestAuditTurnoverAllotInOrder,
            requestUnAuditTurnoverAllotInOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAllotInOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAllotInOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAllotInOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAllotInOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAllotInOrders.UnAudit"
                            },
                       },
                        ...
                        columns: [
                         ...
                         //需要时开启预览和明细
                          ...
                          {attr: { prop: 'isAudit', label: '是否审核', width:100, scopedSlot:'isAudit' } },
                                ...
                                {attr: { prop: 'orderCode', label: '单号', width:160,  } },   
                                {attr: { prop: 'allotInOrgName', label: '调入单位', width:160,  } },   
                    ...
                    return {
                        ...
                        columns: [
                             {attr: { type: 'index',label: '序号', width:65,align: 'center' }},
                                ...
                                {attr: { prop: 'allotInPrice', label: '调入价', width:100,  } },   
                                {attr: { prop: 'allotInOriginalValue', label: '调入原值', width:100,  } },   
    ...
    methods:{
        ...
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/TurnoverAllotInOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getTurnoverAllotInOrderPageList(){
                this.selectRows=[];
                ...
                requestGetTurnoverAllotInOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getTurnoverAllotInOrderPageList();
            this._funcState();
        },
        _add(){
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteTurnoverAllotInOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
            ...
            requestAuditTurnoverAllotInOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditTurnoverAllotInOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

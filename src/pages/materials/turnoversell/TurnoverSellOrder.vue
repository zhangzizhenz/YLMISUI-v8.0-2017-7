<template>
 <yl-panelpage :titleName="'让售单'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetTurnoverSellOrderPageList,
            requestDeleteTurnoverSellOrder,
            requestGetTurnoverSellOrderItemPageList,
            requestAuditTurnoverSellOrder,
            requestUnAuditTurnoverSellOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverSellOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverSellOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverSellOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverSellOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverSellOrders.UnAudit"
                            },
                       },
                        ...
                        columns: [
                             {attr: { type: 'index',label: '序号', width:65,align: 'center' }},
                               ...
                               // {attr: { prop: 'storeRoom', label: '库别', width:100,  } },   
                                ...
                                {attr: { prop: 'sellPrice', label: '让售单价', width:100,  } },   
                                {attr: { prop: 'sellOriginalValue', label: '让售金额', width:100,  } },   
    ...
    methods:{
        ...
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/TurnoverSellOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getTurnoverSellOrderPageList(){
                ...
                requestGetTurnoverSellOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getTurnoverSellOrderPageList();
            this._funcState();
        },
        _add(){
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteTurnoverSellOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
             //初始化表
            requestAuditTurnoverSellOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditTurnoverSellOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

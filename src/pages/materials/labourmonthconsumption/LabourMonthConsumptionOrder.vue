<template>
 <yl-panelpage :titleName="'用料单位月应耗量'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetLabourMonthConsumptionOrderPageList,
            requestDeleteLabourMonthConsumptionOrder,
            requestGetLabourMonthConsumptionOrderItemPageList,
            requestAuditLabourMonthConsumptionOrder,
            requestUnAuditLabourMonthConsumptionOrder
       }   from 'api/materials/labourmonthconsumptionorder';
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.LabourMonthConsumptionOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.LabourMonthConsumptionOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.LabourMonthConsumptionOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.LabourMonthConsumptionOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.CostAnalysis.Analyze.LabourMonthConsumptionOrders.UnAudit"
                            },
                       },
    ...
    methods:{
        //
         _viewItem(id){
            setTimeout(()=>{
                     this._getLabourMonthConsumptionOrderItemPageList(id);
            },300)
        },
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/LabourMonthConsumptionOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getLabourMonthConsumptionOrderPageList(){
                this.selectRows=[];
                ...
                requestGetLabourMonthConsumptionOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
         ...
         _getLabourMonthConsumptionOrderItemPageList(id){
                ...
                requestGetLabourMonthConsumptionOrderItemPageList(this.itemInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getLabourMonthConsumptionOrderPageList();
            this._funcState();
        },
        _itemReload(id){
             this._getLabourMonthConsumptionOrderItemPageList(id);
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteLabourMonthConsumptionOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
             //初始化表单
            requestAuditLabourMonthConsumptionOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditLabourMonthConsumptionOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

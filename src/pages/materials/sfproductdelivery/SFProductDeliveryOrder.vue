<template>
 <yl-panelpage :titleName="'发料单'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetSFProductDeliveryOrderPageList,
            requestDeleteSFProductDeliveryOrder,
            requestGetSFProductDeliveryOrderItemPageList,
            requestAuditSFProductDeliveryOrder,
            requestUnAuditSFProductDeliveryOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.SFProductDeliveryOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.SFProductDeliveryOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.SFProductDeliveryOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.SFProductDeliveryOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Analyze.Rebar.SFProductDeliveryOrders.UnAudit"
                            },
                       },
                    ...
                    return {
                        ...
                        columns: [
                           ...
                           {attr: { prop: 'orderId', label: '预览', width:65, align: 'center',scopedSlot: 'view',showOverflowTooltip:false } },   
                                ...
                                {attr: { prop: 'labourName', label: '用料单位', width:160,  } },   
                                //{attr: { prop: 'gId', label: '工号', width:100,  } },   
    ...
    methods:{
        ...
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/SFProductDeliveryOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getSFProductDeliveryOrderPageList(){
                this.selectRows=[];
                ...
                requestGetSFProductDeliveryOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getSFProductDeliveryOrderPageList();
            this._funcState();
        },
        _add(){
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteSFProductDeliveryOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
            requestAuditSFProductDeliveryOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditSFProductDeliveryOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

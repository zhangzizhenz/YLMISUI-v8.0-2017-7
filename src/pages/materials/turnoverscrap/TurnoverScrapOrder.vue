<template>
 <yl-panelpage :titleName="'报废单'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetTurnoverScrapOrderPageList,
            requestDeleteTurnoverScrapOrder,
            requestGetTurnoverScrapOrderItemPageList,
            requestAuditTurnoverScrapOrder,
            requestUnAuditTurnoverScrapOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverScrapOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverScrapOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverScrapOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverScrapOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverScrapOrders.UnAudit"
                            },
                       },
    ...
    methods:{
        ...
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/TurnoverScrapOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getTurnoverScrapOrderPageList(){
                this.selectRows=[];
                ...
                requestGetTurnoverScrapOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getTurnoverScrapOrderPageList();
            this._funcState();
        },
        _add(){
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteTurnoverScrapOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
             //初始化表单
            requestAuditTurnoverScrapOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditTurnoverScrapOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

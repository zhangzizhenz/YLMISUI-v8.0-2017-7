...
import  {requestGetMaterialAnalyzeList} from 'api/materials/materialsanalyze'
export default {
    data(){
        return {
             tableData: {},
                        ...
                        return {
                            ...
                            columns: [
                                // {attr: { type: 'index',label: '序号', width:80,align: 'center' }},
                                 {attr: { prop: 'id', label: 'ID', width:120,  } },   
                                {attr: { prop: 'infoName', label: '材料名称', width:120,  } },    
                                {attr: { prop: 'lastMonthQuantity', label: '上月盘点', width:120,  } },  
                                {attr: { prop: 'receiveQuantity', label: '本月进料', width:120,  } },   
                                {attr: { prop: 'currMonthQuantity', label: '本月盘点', width:120,  } },   
                                {attr: { prop: 'deliveryQuantity', label: '本月消耗', width:120,  } },   
                                {attr: { prop: 'llDeliveryQuantity', label: '账面消耗数量', width:120,  } },  
                                {attr: { prop: 'jcQuantity', label: '节超数量', width:120,  } },    
    ...
    methods:{
        _getLopItemPageList(){
                ...
                requestGetMaterialAnalyzeList(params).then(data =>{
                            if(data.success){
                                let obj={};

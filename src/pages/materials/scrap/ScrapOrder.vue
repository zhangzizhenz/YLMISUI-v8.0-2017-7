...
import {
            requestGetScrapOrderPageList,
            requestDeleteScrapOrder,
            requestGetScrapOrderItemPageList,
            requestAuditScrapOrder,
            requestUnAuditScrapOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Consume.Delivery.ScrapOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Consume.Delivery.ScrapOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Consume.Delivery.ScrapOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Consume.Delivery.ScrapOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Consume.Delivery.ScrapOrders.UnAudit"
                            },
                       },
                ...
                get () {
                    return {
                        ...
                        {attr: { prop: 'isAudit', label: '审核状态', width:100, scopedSlot:'isAudit' } },     
                                ...
                                {attr: { prop: 'scrapReason', label: '报废原因', width:100,  } },   
                    ...
                    return {
                        ...
                        columns: [
                            {attr: { type: 'index',label: '序号', width:65,align: 'center' }},
                                ...
                                {attr: { prop: 'scrapPrice', label: '报废价', width:100,  } },   
                                {attr: { prop: 'purchasedSum', label: '报废金额', width:100,  } },  
    ...
    methods:{
        //
         _viewItem(id){
            setTimeout(()=>{
                     this._getScrapOrderItemPageList(id);
            },300)
        },
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/ScrapOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getScrapOrderPageList(){
                ...
                requestGetScrapOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
         ...
         _getScrapOrderItemPageList(id){
                ...
                requestGetScrapOrderItemPageList(this.itemInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteScrapOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
             //初始化表单
            requestAuditScrapOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditScrapOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

<template>
 <yl-panelpage :titleName="'进料登记'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
                    <el-form :inline="true"  >
                         <el-form-item class="form-content-vertical">
                            ...
                            <el-form-item class="form-content-vertical">
                                <el-input  placeholder="单号查询" size="small" style="width:180px" v-model="searchModel.orderCode"></el-input> 
                            </el-form-item>
                            <el-form-item class="form-content-vertical">
                                 <el-date-picker  
...
import {
            requestGetRequistionInOrderPageList,
            requestDeleteRequistionInOrder,
            requestGetRequistionInOrderItemPageList,
            requestAuditRequistionInOrder,
            requestUnAuditRequistionInOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Consume.RequistionIn.RequistionInOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Consume.RequistionIn.RequistionInOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Consume.RequistionIn.RequistionInOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Consume.RequistionIn.RequistionInOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Consume.RequistionIn.RequistionInOrders.UnAudit"
                            },
                       },
                        ...
                        columns: [
                         ...
                         //需要时开启预览和明细
                              ...
                              {attr: { prop: 'isAudit', label: '审核状态', width:100,  scopedSlot:'isAudit'} },      
                                // {attr: { prop: 'orgName', label: '名称', width:160,  } },   
                                {attr: { prop: 'orderCode', label: '单据编号', width:140,  } },  
                                {attr: { prop: 'supplierName', label: '供应单位', width:140,  } },   
                                {attr: { prop: 'orderDate', label: '账期', width:100,  } },   
                                {attr: { prop: 'contractCode', label: '合同编号', width:130,  } },  
                                {attr: { prop: 'storePosition', label: '存放地', width:140,  } },  
                                {attr: { prop: 'orderNumber', label: '运料单号', width:130,  } }, 
                    ...
                    return {
                        ...
                        columns: [
                            {attr: { type: 'index',label: '序号', width:65,align: 'center' }},
                                ...
                                {attr: { prop: 'receivedQuantity', label: '已收料数量', width:100,  } },   
    ...
    methods:{
        //
         _viewItem(id){
            setTimeout(()=>{
                     this._getRequistionInOrderItemPageList(id);
            },300)
        },
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/RequistionIn.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getRequistionInOrderPageList(){
                ...
                //排序
                this.mainInput.inputModel.sorting="orderDate desc";
                this.mainInput.addqueryConditionItem(inputArr);
                requestGetRequistionInOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
         ...
         _getRequistionInOrderItemPageList(id){
                ...
                requestGetRequistionInOrderItemPageList(this.itemInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getRequistionInOrderPageList();
            this._funcState();
        },
        _itemReload(id){
             this._getRequistionInOrderItemPageList(id);
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteRequistionInOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
            ...
            requestAuditRequistionInOrder(obj).then(data=>{
                if(data.success){
        ...
        _unAudit(){
            ...
            obj.id=this.selectRows[0].id;
            obj.orgId=this.selectRows[0].orgId;
            requestUnAuditRequistionInOrder(obj).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',

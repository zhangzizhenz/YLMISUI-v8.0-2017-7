<template>
 <yl-panelpage :titleName="'摊销单'" :fullscreenisShow="true" :icon="'icon-library'">
	<div slot="content">
    <yl-layout>
        <div slot="fristbox">
             <yl-toolbar>
...
import {
            requestGetTurnoverAmortizeOrderPageList,
            requestDeleteTurnoverAmortizeOrder,
            requestGetTurnoverAmortizeOrderItemPageList,
            requestAuditTurnoverAmortizeOrder,
            requestUnAuditTurnoverAmortizeOrder
...
export default {
        ...
        return{
             ...
             funBtnConf: {
                            add:{
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAmortizeOrders.Create"
                            },
                            edit:{
                                name:'edit',
                                icon:'icon-pencil',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAmortizeOrders.Edit"
                            },
                            delete:{ 
                                name:'delete',
                                icon:'icon-trashcan',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAmortizeOrders.Delete"
                            },
                             audit:{
                                name:'audit',
                                icon:'icon-user-plus',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAmortizeOrders.Audit"
                            },
                             unAudit:{
                                name:'unAudit',
                                ...
                                permissionSetting:"Materials.Turnover.Amortization.TurnoverAmortizeOrders.UnAudit"
                            },
                       },
                        ...
                        columns: [
                         ...
                         //需要时开启预览和明细
                           ...
                           {attr: { prop: 'orderId', label: '预览', width:65, align: 'center',scopedSlot: 'view',showOverflowTooltip:false } },   
                                ...
                                {attr: { prop: 'orgName', label: '记账单位', width:150,  } },  
                                {attr: { prop: 'labourName', label: '用料单位', width:150,  } },     
                                {attr: { prop: 'ghName', label: '工号', width:100,  } },      
                    ...
                    return {
                        ...
                        columns: [
                             {attr: { type: 'index',label: '序号', width:65,align: 'center' }},
                                ...
                                {attr: { prop: 'amortizeSum', label: '摊销额', width:100,  } },   
                                {attr: { prop: 'amortizeTime', label: '总工期/工作量', width:130,  } },   
                                {attr: { prop: 'currAmoritzeQuantity', label: '摊销数量', width:100,  } },   
                                {attr: { prop: 'currAmortizeNum', label: '摊销工期/工作量', width:130,  } },  
    ...
    methods:{
        ...
        //预览单据接口
        _printPage(id){
            this.reportUrl=config.reportUrl+"/TurnoverAmortizeOrder.html?id="+id;
        ...
        _currentChange(val){
         ...
         _getTurnoverAmortizeOrderPageList(){
                this.selectRows=[];
                ...
                requestGetTurnoverAmortizeOrderPageList(this.mainInput.inputModel).then(data =>{
                    if(data.success){
        ...
        _reload(){
            this._getTurnoverAmortizeOrderPageList();
            this._funcState();
        },
        _add(){
        ...
        _delete(){
            this.$confirm('确认要删除所选项目吗?', '提示', {
                ...
                requestDeleteTurnoverAmortizeOrder(obj).then(data =>{
                        if(data.success){
                                this._reload();
                                this.$notify({
                                    title: '成功',
        ...
        _audit(){
             //初始化表单
            requestAuditTurnoverAmortizeOrder(this.selectRows[0].id).then(data=>{
                if(data.success){
        ...
        _unAudit(){
             requestUnAuditTurnoverAmortizeOrder(this.selectRows[0].id).then(data=>{
               if(data.success){
                    if(data.result.result>0){
                         this.$notify({
                                    title: '成功',
